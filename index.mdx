...
<Steps>
<Step title="Source" icon="users">
Find the most qualified domain experts for your specific use case through our rigorous vetting process.
</Step>

<Step title="Screen" icon="magnifying-glass">
Experts undergo comprehensive interview loops and task-based assessments to ensure quality.
</Step>

<Step title="Manage" icon="cog-6-tooth">
Complete onboarding, training, ongoing support, and performance management for all contributors.
</Step>

<Step title="Annotate" icon="pencil">
Contributors perform annotation tasks using our custom-built, highly intuitive tasking interfaces.
</Step>

<Step title="Review" icon="eye">
Every completed task goes through multiple levels of rigorous human review and quality validation.
</Step>

<Step title="Audit" icon="shield-check">
Final deliverables undergo comprehensive auditing processes to ensure they meet quality standards.
</Step>

<Step title="Deliver" icon="check-circle">
Your completed, high-quality dataset is delivered ready for immediate use in your workflows.
</Step>
</Steps>
