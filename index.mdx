...
<Steps>
<Step title="Targeted Sourcing" icon="clipboard">
</Step>

<Step title="Resume Screening" icon="document-magnifying-glass">
</Step>

<Step title="AI Interview" icon="face-smile">
</Step>

<Step title="Domain Expertise Test" icon="document-check">
</Step>

<Step title="Founder Review" icon="users">
</Step>

<Step title="Selected 1%" icon="check-badge">
</Step>
</Steps>
...
<Steps>
<Step title="Attempt" icon="flag">
</Step>

<Step title="Multiple Stages of Human Review" icon="user-group">
</Step>

<Step title="Batch Audit" icon="document-check">
</Step>

<Step title="Founder Audit" icon="hand-raised">
</Step>

<Step title="Delivery" icon="award">
</Step>
</Steps>
