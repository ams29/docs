...
<AccordionGroup>
<Accordion title="Traffic Scene Understanding">
```json
{
  "video_id": "av_001",
  "scene_context": {
  ...
  "traffic_signals": [
    {
      ...
      "state_sequence": [
        {"time": 0.0, "state": "red"},
        {"time": 5.2, "state": "green"},
        {"time": 15.8, "state": "yellow"}
      ]
    }
  ]
}
...
<Accordion title="Driving Behavior Analysis">
```json
{
  "video_id": "av_002",
  "driving_events": [
    {
      ...
      "end_time": 15.7,
      "safety_score": 0.85,
      "indicators_used": true,
      "clearance_distance": 4.2  // meters
    },
    {
      "event": "emergency_braking",
      "timestamp": 45.2,
      "trigger": "pedestrian_jaywalking",
      "reaction_time": 0.8,  // seconds
      "stopping_distance": 12.5  // meters
    }
  ]
}
```
  ...
  "players": [
    {
      ...
      "tracking_data": [
        {
          "timestamp": 120.5,
          "court_position": [5.2, 8.7],  // meters
          "velocity": [2.1, 0.3],  // m/s
          "possession": true
        }
      ]
    }
...
<AccordionGroup>
<Accordion title="Surgical Procedure Analysis">
```json
{
  "surgery_id": "surg_001",
  ...
  "annotations": [
    {
      "phase": "trocar_insertion",
      "start_time": 180.5,
      "end_time": 245.3,
      "instruments": ["trocar", "insufflator"],
      "assessment": "standard_technique"
    },
    {
...
<Accordion title="Rehabilitation Progress">
```json
{
  "session_id": "rehab_001",
  "patient_id": "pt_123",
  "exercise": "knee_flexion",
  "measurements": [
    {
      "timestamp": 30.0,
      "flexion_angle": 67.5,  // degrees
      "movement_quality": "good",
      "pain_level": 2  // 1-10 scale
    }
  ]
}
```
...
<Card title="Object Tracking" icon="target">
**Tracking Quality**
...
| Video Quality | Storage per Hour | Processing Power | Bandwidth |
|--------------|------------------|------------------|-----------|
| 480p | 1-2 GB | 2-4 CPU cores | 50 Mbps |
| 720p | 3-5 GB | 4-8 CPU cores | 100 Mbps |
| 1080p | 5-8 GB | 8-16 CPU cores | 200 Mbps |
| 4K | 20-40 GB | 32+ CPU cores + GPU | 500+ Mbps |
